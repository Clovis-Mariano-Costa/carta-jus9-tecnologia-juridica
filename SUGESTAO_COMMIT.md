...
```txt
feat: alinhar Carta Jus 9 ao padrão visual institucional
```

## Description

```txt
Consolida o repertório carta-jus9-tecnologia-juridica no Mão na Massa Final da Jus 9, com padrão visual obrigatório, modelo de assinatura com ©, orientações de leitura obrigatória, segurança, classificação de conteúdo e instruções para futuras alterações.
